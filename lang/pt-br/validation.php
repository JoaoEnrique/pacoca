...
return [
    ...
    */
    ...
    'ascii' => 'O campo :attribute deve conter somente caracteres alfanuméricos de um byte e símbolos.',
    ...
    | convenção "attribute.rule" para nomear as linhas. Isso nos permite especificar
    | uma mensagem personalizada específica para uma determinada regra de atributo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma são usadas para substituir nosso marcador de posição de atributo
    | por algo mais fácil de entender, como "Endereço de e-mail" em vez de "email".
